...
<head>
    ...
    <meta name="csrf-token" content="HbpjsRZJMKXmJPkC0EYgetneBz2Ni1FKvZWSqIMn">
    <meta name="description" content="Fly to the GTA 5 RP server. Best-in-class RP project with voice chat, unique systems and many online players.">
    <title>FiveLive — Discover the game!</title>
    <link rel="stylesheet" href="css/reset.css">
    <link rel="stylesheet" href="css/fonts.css">
    <link rel="stylesheet" href="css/scroll.css">
    <link rel="stylesheet" href="css/main5e53.css?v=1672425198">

    <script src="js/jquery.min592e.js?ver=3"></script>
    <script src="js/scroll.js"></script>
    <script src="js/circle-progress.min.js"></script>
    <script src="js/jquery.nice-select.min.js"></script>
    <script src="js/validate.js"></script>
    <script src="js/swal.js"></script>
    <script src="js/countimator.js"></script>
    <script src="js/countdown.plugin.js"></script>
    <script src="js/countdown.js"></script>
    <script src="js/scripts5e53.js?v=1672425198"></script>


    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-238481638-1"></script>
    <script>
        ...
        gtag('config', 'UA-238481638-1');

        function gtag_report_conversion(url, lang) {
            gtag('event', 'download_' + lang, {
...
<body class="main_page">
    ...
    <div class="promo_window">
        ...
        <h3>Don't miss the<br> free bonus!</h3>
        <p>Silver VIP status for 14 days.</p>
        <p>When you reach level 3, <br> you will receive $15,000 in-game currency.</p>
        <div class="promo_window_code copy-block">
            ...
            <span class="promo_window_code_title">Promo code</span>
        </div>
        <!-- /.promo_window_code -->
        <a style="display: none" class="promo_window_button launcher_button"
            href="https://outside.gtavrp.ru/launcher_eng/FiveLive%20Setup.exe">
            Download launcher
        </a>
        <span class="promo_user_select">I already have a launcher</span>
        <h3>14 Days</h3>
        <h5>Free</h5>
    </div>
    <!-- /.promo_window -->
    <div class="window settings_window recovery">
        ...
        <!-- /.window_top -->
        <form method="POST" action="https://fivelive.net/request/reset_password">
            <input type="hidden" name="_token" value="HbpjsRZJMKXmJPkC0EYgetneBz2Ni1FKvZWSqIMn">
            <div class="window_section">
                <h3>Select server</h3>
                <div class="server_select">
                    <select name="server">
                        <option data-display="Turkey" value="1" selected>Turkey</option>
                        <option value="2.html">English</option>
                        <option value="3.html">Brazil</option>
                    </select>
                </div>
                <!-- /.server_select -->
            </div>
            ...
            <div class="window_section">
                <div class="nickname">
                    <input type="text" name="nickname" placeholder="Member login">
                </div>
                <!-- /.nickname -->
            </div>
            <!-- /.window_section -->
    ...
    <div class="session ">
        <div class="container default">
            ...
            <div class="session_content">
                ...
                <!-- /.session_title -->
                <form action="https://fivelive.net/request/auth" method="POST" class="login">
                    <input type="hidden" name="_token" value="HbpjsRZJMKXmJPkC0EYgetneBz2Ni1FKvZWSqIMn">
                    <h3>Select server</h3>
                    <div class="server_select">
                        <select name="server">
                    ...
                    <div class="username nickname">
                        <input type="text" name="username" placeholder="Member login">

                    </div>
                    <!-- /.nickname -->
                    <div class="password">
                        <input type="password" class="default" name="password" placeholder="Password">

                    </div>
                    <!-- /.password -->
                    <button name="button" class="continue_button">Login</button>
    ...
    <div data-scroll-container class="page">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const deadline = new Date("2022-10-29T22:00:00.000+03:00");
                // id таймера
                let timerId = null;
                ...
                function countdownTimer() {
                    ...
                    $timer.textContent = 'Europe | ' + days + ':' + hours + ':' + minutes + ':' + seconds;
                }
        ...
        <header id="header_trigger">
            <div class="container">
                <div class="header_top">
                    <a href="index.html" class="logo linkout"></a>
                    <nav>
                        <ul>
                            <li>
                                <a href="https://forum.fivelive.net/">Forum</a>
                            </li>
                            <li>
                                <a href="#news_trigger" data-scroll-to>News</a>
                            </li>
                            <li style="flex: auto">
                                <a href="donate.html" class="shop linkout">Shop</a>
                            </li>
                            <li>
                                <a href="donate_promo.html" class="header_kinguin_code">Promocode</a>
                            </li>
                        </ul>
                    </nav>
                    <div class="header_additional">
                        <a class="header_additional_discord" href="https://discord.com/invite/hWmdeEH9he" target="_blank">Discord</a>
                        <div class="language">
                            <span>EN</span>
                            <ul>
                                <li>
                                    <a href="index.html" class="language_item language_item--en">EN</a>
                                </li>
                                <li>
                                    <a href="tr.html" class="language_item language_item--tr">TR</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.language -->
                    </div>
                    <a class="header_mob_discord" href="https://discord.gg/8t7BZ7W5b8" target="_blank"></a>

                    <div class="userpanel">
                        <a href="#steps_trigger" data-scroll-to> How to start playing</a>
                ...
                <div class="main_page_header_row">
                    <div class="promo" style="margin-top: 50px">
                        <h3>Full immersion <br> in GTA V</h3>
                        <p>Immerse in a wonderful RolePlay world!</p>
                        <div class="promo_buttons">
                            <a href="#steps_trigger" data-scroll-to class="start_play">
                                <span>Start to play</span>
                            </a>
                            <a href="#" class="watch videotoggle"
                                data-video-embed="https://www.youtube.com/embed/itQSocAcnsE">
                                <h3>Watch our guide</h3>
                                <span></span>
                            </a>
                        </div>
                        <!-- /.promo_buttons -->
        ...
        <div class="navigation_window">
            ...
            <ul>
                <li><a href="https://forum.fivelive.net/">Forum</a></li>
                <li><a href="news.html">News</a></li>
                <li><a href="#steps_trigger" data-scroll-to onclick="$('.navigation_window_close').trigger('click')">How to start playing</a>
                </li>
                <li class="window_discord_link">
                    <a href="https://discord.gg/8t7BZ7W5b8" target="_blank"><span>Discord</span></a>
                </li>
                <li class="promo_kinguin_link">
                    <a href="donate_promo.html"><span>Promocode</span></a>
                </li>
                <li class="btn_shop_link">
                    <a href="donate.html"><span>Shop</span></a>
                </li>
            </ul>
            <div class="navigation_window_online">
                <div class="navigation_window_online_total">
                    <h3 class="server_all">233</h3>
                    <span> online</span>
                </div>
                <!-- /.navigation_window_online_total -->
                <div class="window_server">
                    <div class="window_circle california window_turkey_server circle_0"></div>
                    <h3 class="server_0">137</h3>
                    <span>Turkey</span>
                </div>
                <!-- /.window_server -->
            </div>
        ...
        <div class="steps_section" id="steps_trigger">
            <div class="steps">
                <div class="steps_row is-inview">
                    <div class="step buy">
                        ...
                        <div class="step_description">
                            <h3>Buy a licensed GTA 5 <br> version</h3>
                            <p>
                                Buy a licensed <br> GTA 5 version in <br> the store to play on our server.
                                <!-- Buy license <br> in store to play <br> on our server. -->
                            </p>
                            <a href="https://store.steampowered.com/app/271590/Grand_Theft_Auto_V/">Buy</a>
                        </div>
                        <!-- /.step_description -->
                    </div>
                    <!-- /.step -->
                    <div class="step install">
                        ...
                        <div class="step_description step_description-download">
                            <h3>Install our launcher</h3>
                            <p>For a comfortable game on our server, <br> we created a personal launcher <br><br></p>
                            <div class="btn-group-download">
                                <a class="step_install_link step_install_link--turkey custom-margin-btn-tu"
                                    onclick="gtag_report_conversion(`https://outside.fivelive.net/launcher_turk/FiveLive%20Setup.exe`,'tr')">Turkey
                                    <i>
                    ...
                    <div class="step start">
                        ...
                        <div class="step_description">
                            <h3>Run Launcher</h3>
                            <p>
                                If you are ready to <br> become a part of the incredible RolePlay <br> world, click
                                on the button below and join us!
                                <!-- Dual integrated <br> game launcher <br>running  via <br> our launcher  -->
                            </p>
                            <a href="fivelive://server=english" onclick="//gtag_report_conversion()">Play</a>
                        </div>
                        <!-- /.step_description -->
                    </div>
                    <!-- /.step -->
                ...
                <h2 data-scroll data-scroll-direction="horizontal" data-scroll-speed="-6"
                    data-scroll-target="#steps_trigger">Start Game</h2>
                <h3 data-scroll data-scroll-direction="horizontal" data-scroll-speed="2"
                    data-scroll-target="#steps_trigger">Right now</h3>
        ...
        <div class="news" data-scroll id="news_trigger">
            <div class="container">
                <div class="news_row">
                    ...
                    <a href="news.html" class="all_news">All news <span>4</span></a>

                    <div class="news_container">
                        <div class="news_container_unit">
                            <a href="article_04.html">
                                <h3 class="new-style">OUR NEW SERVER IS RUNNING!<br> </h3>

                                <p>
                                    Our new server is running! <br><br>
                                    Now you can easily start your exciting in-game life on server “Europe.” Create a
                                    family, participate in cool events and just have fun!
                                </p>
                        ...
                        <div class="news_container_unit">
                            <a href="article_03.html">
                                <h3>30.09 UPDATE / NEXT LEVEL FAMILIES</h3>
                                <p>
                                    We wanted to give the players the freedom to mold their gameplay just as they
                                    wanted, whenever they wanted. The Sky's the limit we thought, and we made it bigger
                                    and better with a lot of capabilities
                                </p>
        ...
        <div class="communication" data-scroll>
            <div class="container">
                <div class="follow">
                    <h3>Keep in touch</h3>
                    <p>Subscribe to our social networks and <br> be updated on all the news</p>
                    <ul>
                        <li><a href="https://discord.gg/8t7BZ7W5b8" class="discord">Discord</a></li>
                        <li><a href="https://www.facebook.com/groups/207923511077194" class="facebook">Facebook</a></li>
                        <li><a href="https://twitter.com/FiveLive11" class="twitter">Twitter</a></li>
                    </ul>
                </div>
                <!-- /.follow -->
                <div class="parthnership">
                    <h3>Partnership</h3>
                    <p>Follow the link to <br> offer your cooperation</p>
                    <a href="partnership.html"></a>
                </div>
                <!-- /.parthnership -->
            </div>
            <!-- /.container -->
            ...
            <div class="container">
                <div class="footer_leftSide">
                    <div class="copyright">
                        ...
                        <p>Copyright © 2022 FiveLive.net <br>All rights reserved</p>

                    </div>
                    <!-- /.copyright -->
                    <a href="mailto:support@fivelive.net" class="mail">support@fivelive.net</a>
                    <ul class="social">
                        <li><a href="https://www.facebook.com/groups/207923511077194" class="facebook"></a></li>
                        <li><a href="https://twitter.com/FiveLive11" class="twitter"></a></li>
                        <li><a href="https://www.instagram.com/fivelive.official/" class="instagram"></a></li>
                        <li><a href="https://www.youtube.com/channel/UCXno2yJFGCGe8B1HcfTJbLA" class="youtube"></a></li>
                    </ul>
                </div>
                <!-- /.footer_leftSide -->
                <nav>
                    <ul>
                        <li><a href="news.html">News</a></li>
                        <li><a href="donate.html">Shop</a></li>
                        <li><a href="#steps_trigger" data-scroll-to>Start game</a></li>
                    </ul>
                    <ul>
                        <li><a href="policy.html">Privacy Policy</a></li>
                        <li><a href="contract.html">User agreement</a></li>
                        <li><a href="chargeback.html">Money back policy</a></li>
                    </ul>
                </nav>
                <div class="footer_contacts">
                    <p>
                        Brazy Portugal LTD,reg.number 516534165, Praça Aires de Ornelas,
                        Número 3, 6 A, Lisboa, freguesia de Penha de França, concelho de Lisboa. <br>
                        +351920371103<br>
                        Support support@fivelive.net
                    </p>
                </div>
                <!-- /.footer_contacts -->
            </div>
