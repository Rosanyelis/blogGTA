    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ url('panel-administrativo/configuraciones/usuarios/'.$data->id.'/actualizar-usuario') }}">
                    @csrf
                    @method('PUT')
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" name="username" class="form-control form-control-solid" value="{{ $data->username }}" placeholder=""  />
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" name="email" class="form-control form-control-solid" value="{{ $data->email }}" placeholder=""  />
                            @if ($errors->has('email'))
                                <span class="text-danger">
                                    {{ $errors->first('email') }}
                                </span>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <select name="rol_id" class="form-select" aria-label="Select example">
                                ...
                                <option value="{{ $item->id }}" @if ($item->id == $data->rol_id) selected @endif>{{ $item->nombre }} - {{ $item->descripcion }}</option>
                                @endforeach
                            </select>
