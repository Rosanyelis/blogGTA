    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/configuraciones/usuarios/nuevo-usuario') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nuevo Usuario</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <thead>
                            <tr class="fw-bolder fs-6 text-gray-800 px-7">
                                ...
                                <th class="min-w-100px">Usuarios</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="{{ url('panel-administrativo/configuraciones/usuarios/'.$item->id.'/editar-usuario') }}">
                                        <i class="fas fa-pen-square fs-1"></i>
                                    </a>&nbsp;&nbsp;
                                    @endif
                                    @endif

                                    @if (Auth::user()->rol->nombre == 'Superadmin' OR Auth::user()->rol->nombre == 'Administrador')
                                    <a href="{{ url('panel-administrativo/configuraciones/usuarios/'.$item->id.'/editar-usuario') }}">
                                        <i class="fas fa-pen-square fs-1"></i>
                                    </a>&nbsp;&nbsp;
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/configuraciones/usuarios/'.$item->id.'/eliminar-usuario') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
