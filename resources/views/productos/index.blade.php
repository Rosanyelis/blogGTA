    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/productos/nuevo-producto') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nuevo Producto</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-50px">
                                            <span class="symbol-label" style="background-image:url({{ asset(''.$item->url_imagen.'') }});"></span>
                                        </div>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <span class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{ $item->nombre }}</span>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>{{ $item->precio }}</td>
                                <td class="text-end">
                                    <a href="{{ url('panel-administrativo/productos/'.$item->id.'/editar-producto') }}">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/productos/'.$item->id.'/eliminar-producto') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
