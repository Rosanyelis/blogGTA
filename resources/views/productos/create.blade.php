        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                    action="{{ url('panel-administrativo/productos/guardar-producto') }}"
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" name="nombre" class="form-control form-control-solid" placeholder="Servidor Publicado de GTA Latam" value="{{ old('nombre') }}"  />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" name="cantidad" class="form-control form-control-solid" placeholder="20" value="{{ old('cantidad') }}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text"  name="precio" class="form-control form-control-solid" placeholder="20" value="{{ old('precio') }}">
