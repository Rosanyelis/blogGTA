        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                    action="{{ url('panel-administrativo/noticias/guardar-noticia') }}"
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" name="titulo" class="form-control form-control-solid" placeholder="Servidor Publicado de GTA Latam"  />
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-bold mb-2">Contenido de Noticia</label>
                            <textarea name="contenido" id="kt_docs_ckeditor_classic"></textarea>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--begin::Actions-->
