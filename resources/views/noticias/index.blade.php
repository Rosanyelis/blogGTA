    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/noticias/nueva-noticia') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nueva Noticia</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <thead>
                            <tr class="fw-bolder fs-6 text-gray-800 px-7">
                                ...
                                <th class="min-w-200px">Noticia</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->titulo }}</td>
                                <td class="text-end">
                                    <a href="{{ url('panel-administrativo/noticias/'.$item->id.'/editar-noticia') }}">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/noticias/'.$item->id.'/eliminar-noticia') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
