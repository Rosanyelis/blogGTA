        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Configuraciones
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Categorias de Productos</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/configuraciones/categorias-de-productos/nueva-categoria') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nueva Categoría</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->nombre }}</td>
                                <td class="text-end">
                                    <a href="{{ url('panel-administrativo/configuraciones/categorias-de-productos/'.$item->id.'/editar-categoria') }}">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/configuraciones/categorias-de-productos/'.$item->id.'/eliminar-categoria') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
