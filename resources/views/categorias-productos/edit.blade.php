    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ url('panel-administrativo/configuraciones/categorias-de-productos/'.$data->id.'/actualizar-categoria') }}">
                    @csrf
                    @method('PUT')
