    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/configuraciones/paginas-estaticas/nueva-pagina') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nueva Página</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->nombre }}</td>
                                <td class="text-end">
                                    <a href="{{ url('panel-administrativo/configuraciones/paginas-estaticas/'.$item->id.'/editar-pagina') }}">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/configuraciones/paginas-estaticas/'.$item->id.'/eliminar-pagina') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
