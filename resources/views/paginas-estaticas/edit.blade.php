        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Configuraciones
                    ...
                    <!--end::Description-->
                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Editar Página</small>
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                        action="{{ url('panel-administrativo/configuraciones/paginas-estaticas/'.$data->id.'/actualizar-pagina') }}">
                        @csrf
                        @method('PUT')
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-12 fv-row">
                                ...
                                <textarea type="text" name="contenido" class="form-control form-control-solid" placeholder="Escribe el contenido..."
                                    rows="8" id="ckeditor_classic">{{ $data->contenido }}</textarea>
                        ...
                        <!--begin::Actions-->
                        <div class="text-end">
                            <a href="{{ url('panel-administrativo/configuraciones/paginas-estaticas') }}"
