    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ url('panel-administrativo/configuraciones/redes-sociales/nueva-red-social') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Nueva Red Social</a>
                <!--end::Primary button-->
            </div>
        <!--end::Actions-->
        </div>
                    ...
                    <table id="kt_datatable_example_5"
                        ...
                        <thead>
                            <tr class="fw-bolder fs-6 text-gray-800 px-7">
                                ...
                                <th class="min-w-100px">Red Social</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->url }}</td>
                                <td class="text-end">
                                    <a href="{{ url('panel-administrativo/configuraciones/redes-sociales/'.$item->id.'/editar-red-social') }}">
                                    ...
                                    <div class="modal fade" tabindex="-1" id="Delete-{{ $item->id }}">
                                        <div class="modal-dialog">
                                            <form method="POST" action="{{ url('panel-administrativo/configuraciones/redes-sociales/'.$item->id.'/eliminar-red-social') }}" class="modal-content">
                                                @csrf
                                                @method('DELETE')
